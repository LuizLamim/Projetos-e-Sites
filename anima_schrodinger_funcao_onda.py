...
line_imag, = ax.plot([], [], label='Parte Imaginária $\Im(\Psi)$', color='#FF8C00', alpha=0.7)
line_prob, = ax.plot([], [], label='Densidade de Probabilidade $|\Psi|^2$', color='#E81123', linewidth=2.5)
