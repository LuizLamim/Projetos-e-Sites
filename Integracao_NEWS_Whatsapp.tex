...
% Redefinir o estilo 'plain' para que o \maketitle o utilize com a logo
\fancypagestyle{plain}{
    \fancyhf{}
    \fancyhead[L]{\includegraphics[width=2cm]{img/Logo_Luiz.png}}
    \renewcommand{\headrulewidth}{0pt}
}

% Garantir que as outras páginas não tenham cabeçalho
\pagestyle{empty}

\title{\vspace{-1.5cm}\vspace{2cm}\textbf{Arquitetura de Integração: Inteligência Artificial e WhatsApp}\\ \large Curadoria Diária de Notícias sobre Recuperação Judicial}
